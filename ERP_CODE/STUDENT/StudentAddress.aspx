...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="height:560px; width:880px">
      <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="560px" Width="880px" BorderColor="White" BorderStyle="Solid"  BorderWidth="0px" style="border:1px solid #fff !important;">
                   ...
                   <table class="auto-style1">
                    ...
                    <tr>
                          <td class="odd" style="width: 90px; height:30px">
                            <asp:Label ID="Label122" runat="server" Text="House Name /No." Width="90px"></asp:Label>
                          </td>
                            <td class="odd" style="width: 211px; height:30px">
                              <asp:TextBox ID="TxtHouseNamePerm" runat="server" placeholder="House Name /No." Width="280px" TabIndex="1"></asp:TextBox>
                          </td>

                           <td class="odd" style="width: 90px; height:30px" >
                             <asp:Label ID="Label126" runat="server" Text="House Name /No." Width="90px"></asp:Label>
                        </td>
                         <td class="odd" width="200px" >
                              <asp:TextBox ID="TxtHouseNameTemp" runat="server" placeholder="House Name /No." Width="280px" TabIndex="13"></asp:TextBox>
                          </td>
                          <tr>
                              <td class="odd" style="width: 90px; height:30px">
                          ...
                          <tr>
                              ...
                              <td class="odd" style="width: 211px; height:30px">
                                  <asp:TextBox ID="TxtPinCodePerm" runat="server" placeholder="Pin Code" Width="280px" TabIndex="3" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                              <td class="odd" style="width: 90px; height:30px">
                                  <asp:Label ID="Label4" runat="server" Text="Pin Code" Width="90px"></asp:Label>
                              </td>
                              <td class="odd" width="180px">
                                  <asp:TextBox ID="TxtPinCodeTemp" runat="server" placeholder="Pin Code" Width="280px" TabIndex="16" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                          </tr>
                          <tr>
                              <td class="odd" style="width: 90px; height:30px">
                          ...
                          <tr>
                              ...
                              <td class="odd" style="width: 211px; height:20px">
                          ...
                          <tr>
                              ...
                              <td class="odd" style="width: 211px; height:30px">
                                  <asp:TextBox ID="TxtPhoneNoPerm" runat="server" placeholder="Phone no." Width="280px" TabIndex="8" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                              <td class="odd" style="width: 90px; height:30px">
                                  <asp:Label ID="Label12" runat="server" Text="Phone no." Width="90px"></asp:Label>
                              </td>
                              <td class="odd" width="180px">
                                  <asp:TextBox ID="TxtPhoneNoTemp" runat="server" placeholder="Phone no." Width="280px" TabIndex="21" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                          </tr>
                          <tr>
                              <td class="odd" style="width: 90px; height:30px">
                          ...
                          <tr>
                              ...
                              <td class="odd" style="width: 211px; height:30px">
                                  <asp:TextBox ID="TxtMobNoPerm" runat="server" placeholder="Mobile No." Width="280px" TabIndex="10" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                              <td class="odd" style="width: 90px; height:30px">
                              ...
                              <td class="odd" style="width: 180px; height:30px" width="180px">
                                  <asp:TextBox ID="TxtMobNoTemp" runat="server" placeholder="Mobile No." Width="280px" TabIndex="23" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                          </tr>
                          <tr>
                              <td class="odd" style="width: 90px; height:20px">
                              ...
                              <td class="odd" style="width: 180px; height: 20px;">
                              ...
                              <tr>
                                  <td style="width: 12px; height: 29px;">
                                      <asp:Label ID="Label95" runat="server" Text="Copy Address To" Width="72px"></asp:Label>
                                  </td>
                                  <td style="width: 211px; height: 29px; text-align:center">
                                      <asp:CheckBox ID="ChkFather" runat="server" SkinID="ChkBox" Text="Father" Width="131px" />
                                  </td>
                                  <td style=" height: 29px; text-align:right">
                                      <asp:CheckBox ID="ChkMother" runat="server" SkinID="ChkBox" Text="Mother" Width="86px" />
                                  </td>
                                  <td style=" height: 29px; text-align:center">
                                      <asp:CheckBox ID="ChkGuardian" runat="server" SkinID="ChkBox" Text="Guardian" Width="133px" />
                                  </td>
                              </tr>
                      
                        <tr>
                            <td align="center" class="FooterCommand" colspan="4" valign="middle">
                                <uc1:CtrlCommand ID="CtrlCommand1" runat="server" ClearTabIndex="26" IsVisibleClear="True" IsVisibleDelete="False" IsVisibleFind="False" IsVisiblePrint="false" SaveTabIndex="25" />
                            </td>
                        </tr>
                        </tr>
             </table>
          ...
          <ajaxToolkit:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel2">
              <HeaderTemplate>Father Address
               ...
               <ContentTemplate>
                    ...
                    <tr>
                          <td class="odd" style="width: 90px; height:30px">
                            <asp:Label ID="Label19" runat="server" Text="House Name /No." Width="90px"></asp:Label>
                          </td>
                            <td class="odd" style="width: 200px; height:30px" width="180px">
                              <asp:TextBox ID="TxtFthrHousePer" runat="server" placeholder="House Name /No." Width="280px" TabIndex="1"></asp:TextBox>
                          </td>

                           <td class="odd" style="width: 90px; height:30px" >
                             <asp:Label ID="Label20" runat="server" Text="House Name /No." Width="90px"></asp:Label>
                        </td>
                         <td class="odd" width="200px" >
                              <asp:TextBox ID="TxtFthrHouseTemp" runat="server" placeholder="House Name /No." Width="280px" TabIndex="13"></asp:TextBox>
                          </td>
                          <tr>
                              <td class="odd" style="width: 90px; height:30px">
                          ...
                          <tr>
                              ...
                              <td class="odd" style="width: 180px; height:30px" width="180px">
                                  <asp:TextBox ID="TxtFthrPincodePer" runat="server" placeholder="Pin Code" Width="280px" TabIndex="4" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                              <td class="odd" style="width: 90px; height:30px">
                                  <asp:Label ID="Label26" runat="server" Text="Pin Code" Width="90px"></asp:Label>
                              </td>
                              <td class="odd" width="180px">
                                  <asp:TextBox ID="TxtFthrPincodeTemp" runat="server" placeholder="Pin Code" Width="280px" TabIndex="16" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                          </tr>
                          <tr>
                              <td class="odd" style="width: 90px; height:30px">
                          ...
                          <tr>
                              ...
                              <td class="odd" style="width: 180px; height:30px" width="180px">
                                  <asp:TextBox ID="TxtFthrPhNoPer" runat="server" placeholder="Phone no." Width="280px" TabIndex="9" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                              <td class="odd" style="width: 90px; height:30px">
                                  <asp:Label ID="Label36" runat="server" Text="Phone no." Width="90px"></asp:Label>
                              </td>
                              <td class="odd" width="180px">
                                  <asp:TextBox ID="TxtFthrPhNoTemp" runat="server" placeholder="Phone no." Width="280px" TabIndex="21" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                          </tr>
                          <tr>
                              <td class="odd" style="width: 90px; height:30px">
                          ...
                          <tr>
                              ...
                              <td class="odd" style="width: 180px; height:30px" width="180px">
                                  <asp:TextBox ID="TxtFthrMobPer" runat="server" placeholder="Mobile No." Width="280px" TabIndex="11" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                              <td class="odd" style="width: 90px; height:30px">
                                  <asp:Label ID="Label40" runat="server" Text="Mobile No." Width="90px"></asp:Label>
                              </td>
                              <td class="odd" style="width: 180px; height:30px" width="180px">
                                  <asp:TextBox ID="TxtFthrMobTemp" runat="server" placeholder="Mobile No." Width="280px" TabIndex="23" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                          </tr>
                          <tr>
          ...
          <ajaxToolkit:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel3">
              <HeaderTemplate>Mother Address
               ...
               <ContentTemplate>
                    ...
                    <tr>
                          <td class="odd" style="width: 90px; height:30px">
                            <asp:Label ID="Label45" runat="server" Text="House Name /No." Width="90px"></asp:Label>
                          </td>
                            <td class="odd" style="width: 200px; height:30px" width="180px">
                              <asp:TextBox ID="TxtMthrHousePer" runat="server" placeholder="House Name /No." Width="280px" TabIndex="1"></asp:TextBox>
                          </td>

                           <td class="odd" style="width: 90px; height:30px" >
                             <asp:Label ID="Label46" runat="server" Text="House Name /No." Width="90px"></asp:Label>
                        </td>
                         <td class="odd" width="200px" >
                              <asp:TextBox ID="TxtMthrHouseTemp" runat="server" placeholder="House Name /No." Width="280px" TabIndex="13"></asp:TextBox>
                          </td>
                          <tr>
                              <td class="odd" style="width: 90px; height:30px">
                          ...
                          <tr>
                              ...
                              <td class="odd" style="width: 180px; height:30px" width="180px">
                                  <asp:TextBox ID="TxtMthrPincodePer" runat="server" placeholder="Pin Code" Width="280px" TabIndex="4" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                              <td class="odd" style="width: 90px; height:30px">
                                  <asp:Label ID="Label52" runat="server" Text="Pin Code" Width="90px"></asp:Label>
                              </td>
                              <td class="odd" width="180px">
                                  <asp:TextBox ID="TxtMthrPincodeTemp" runat="server" placeholder="Pin Code" Width="280px" TabIndex="16" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                          </tr>
                          <tr>
                              <td class="odd" style="width: 90px; height:30px">
                          ...
                          <tr>
                              ...
                              <td class="odd" style="width: 180px; height:30px" width="180px">
                                  <asp:TextBox ID="TxtMthrPhNoPer" runat="server" placeholder="Phone no." Width="280px" TabIndex="9" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                              <td class="odd" style="width: 90px; height:30px">
                                  <asp:Label ID="Label62" runat="server" Text="Phone no." Width="90px"></asp:Label>
                              </td>
                              <td class="odd" width="180px">
                                  <asp:TextBox ID="TxtMthrPhNoTemp" runat="server" placeholder="Phone no." Width="280px" TabIndex="21" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                          </tr>
                          <tr>
                              <td class="odd" style="width: 90px; height:30px">
                          ...
                          <tr>
                              ...
                              <td class="odd" style="width: 180px; height:30px" width="180px">
                                  <asp:TextBox ID="TxtMthrMobPer" runat="server" placeholder="Mobile No." Width="280px" TabIndex="11" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                              <td class="odd" style="width: 90px; height:30px">
                                  <asp:Label ID="Label66" runat="server" Text="Mobile No." Width="90px"></asp:Label>
                              </td>
                              <td class="odd" style="width: 180px; height:30px" width="180px">
                                  <asp:TextBox ID="TxtMthrMobTemp" runat="server" placeholder="Mobile No." Width="280px" TabIndex="23" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                          </tr>
                          <tr>
                              <td class="odd" height="20px" style="width: 90px; height:20px">
              ...
              <HeaderTemplate>Guardian Address
               ...
               <ContentTemplate>
                 <table class="auto-style1">
                    ...
                    <tr>
                          <td class="odd" style="width: 90px; height:30px">
                            <asp:Label ID="Label71" runat="server" Text="House Name /No." Width="90px"></asp:Label>
                          </td>
                            <td class="odd" style="width: 200px; height:30px" width="180px">
                              <asp:TextBox ID="TxtGurdnHousePer" runat="server" placeholder="House Name /No." Width="280px" TabIndex="3"></asp:TextBox>
                          </td>

                           <td class="odd" style="width: 90px; height:30px" >
                             <asp:Label ID="Label72" runat="server" Text="House Name /No." Width="90px"></asp:Label>
                        </td>
                         <td class="odd" width="200px" >
                              <asp:TextBox ID="TxtGurdnHouseTemp" runat="server" placeholder="House Name /No." Width="280px" TabIndex="15"></asp:TextBox>
                          </td>
                          <tr>
                              <td class="odd" style="width: 90px; height:30px">
                          ...
                          <tr>
                              ...
                              <td class="odd" style="width: 180px; height:30px" width="180px">
                                  <asp:TextBox ID="TxtGurdnPincodePer" runat="server" placeholder="Pin Code" Width="280px" TabIndex="6" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                              <td class="odd" style="width: 90px; height:30px">
                                  <asp:Label ID="Label78" runat="server" Text="Pin Code" Width="90px"></asp:Label>
                              </td>
                              <td class="odd" width="180px">
                                  <asp:TextBox ID="TxtGurdnPincodeTemp" runat="server" placeholder="Pin Code" Width="280px" TabIndex="18" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                          </tr>
                          <tr>
                              <td class="odd" style="width: 90px; height:30px">
                          ...
                          <tr>
                              ...
                              <td class="odd" style="width: 180px; height:30px" width="180px">
                                  <asp:TextBox ID="TxtGurdnPhNoPer" runat="server" placeholder="Phone no." Width="280px" TabIndex="11" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                              <td class="odd" style="width: 90px; height:30px">
                                  <asp:Label ID="Label88" runat="server" Text="Phone no." Width="90px"></asp:Label>
                              </td>
                              <td class="odd" width="180px">
                                  <asp:TextBox ID="TxtGurdnPhNoTemp" runat="server" placeholder="Phone no." Width="280px" TabIndex="23" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                          </tr>
                          <tr>
                              <td class="odd" style="width: 90px; height:30px">
                          ...
                          <tr>
                              ...
                              <td class="odd" style="width: 180px; height:30px" width="180px">
                                  <asp:TextBox ID="TxtGurdnMobPer" runat="server" placeholder="Mobile No." Width="280px" TabIndex="13" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                              <td class="odd" style="width: 90px; height:30px">
                                  <asp:Label ID="Label92" runat="server" Text="Mobile No." Width="90px"></asp:Label>
                              </td>
                              <td class="odd" style="width: 180px; height:30px" width="180px">
                                  <asp:TextBox ID="TxtGurdnMobTemp" runat="server" placeholder="Mobile No." Width="280px" TabIndex="25" onkeypress="return isNumberKey(event)"></asp:TextBox>
                              </td>
                          </tr>
                          <tr>
                              <td class="odd" height="20px" style="width: 90px; height:20px">
