<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SubjectMaster.aspx.cs" Inherits="ADMIN_SubjectMaster" StyleSheetTheme="SkinFile" Theme="SkinFile" %>
                        ...
                        <tr>
                         <td class="odd" style="width: 83px; height: 29px;">
                          ...
                          <td class="odd" style="height: 29px">
                              ...
                              <asp:CheckBox ID="ChkIsElective" runat="server" Font-Bold="False" SkinID="ChkSelect" Text="Is Elective" />
                          
                              <asp:CheckBox ID="ChkIsOptional" runat="server" Font-Bold="False" SkinID="ChkSelect" Text="Is Optional" />
                                  ...
                                  <asp:GridView ID="GrdVwRecords" runat="server"   SkinID="GrdVwMaster" OnSelectedIndexChanging="GrdVwRecords_SelectedIndexChanging">
                                      <Columns>
                                          ...
                                          <asp:TemplateField HeaderText="PrintName">
                                              <ItemTemplate>
                                                  <asp:Label ID="LblPrintName" runat="server" SkinID="LblGrdMaster" Text='<%# Eval("DisplayName") %>' Width="100px"></asp:Label>
                                              </ItemTemplate>
                                          </asp:TemplateField>
                                        ...
                                        <asp:BoundField DataField="Remarks" HeaderText="Remarks">
                                          <ItemStyle Width="200px" />
                                            ...
                                            <asp:BoundField DataField="IsElective" HeaderText="IsElective">
                                          <ItemStyle Width="200px" />
                                          </asp:BoundField>
                                          <asp:BoundField DataField="IsOptional" HeaderText="IsOptional">
                                          <ItemStyle Width="200px" />
                                          </asp:BoundField>
