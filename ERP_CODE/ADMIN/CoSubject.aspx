                      ...
                      <tr><td class="odd" style="width: 83px">
                       ...
                       <tr>
                          <td class="odd">
                            ...
                            <td class="odd">
                                            <asp:DropDownList ID="DdlSection" runat="server" SkinID="DdlList">
                                                <asp:ListItem Value="0">Select</asp:ListItem>
                                                <asp:ListItem Value="1">PART 2A</asp:ListItem>
                                                <asp:ListItem Value="2">PART 2B</asp:ListItem>
                                                <asp:ListItem Value="3">PART 2C</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                      </tr>
                        <tr>
