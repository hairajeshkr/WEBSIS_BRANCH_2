<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="General.aspx.cs" Inherits="General" StyleSheetTheme="SkinFile" Theme="SkinFile" %>
    ...
    <div style="height:367px; width:569px">
      <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="365px" Width="560px" BorderColor="White" BorderStyle="Solid" BorderWidth="0px" style="border:1px solid #fff !important;">
          <ajaxToolkit:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
              <HeaderTemplate> 
                  <asp:Label ID="LblHdr" runat="server" Text="Reg" SkinID="LblTabHdr" Width="200px"></asp:Label>
              </HeaderTemplate>
          ...
          <ajaxToolkit:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
              <HeaderTemplate>
                  <asp:Label ID="LblHdr1" runat="server" Text="LIST" SkinID="LblTabHdr" Width="230px"></asp:Label>
              </HeaderTemplate>
              ...
              <ContentTemplate>
                  <table style="width: 100%; height: 0px;">
                      ...
                      <tr>
                          <td colspan="5">
                              <div class="result-list" style="overflow: scroll; height: 300px;">
                                  <asp:GridView ID="GrdVwRecords" runat="server" OnPageIndexChanging="GrdVwRecords_PageIndexChanging" OnSelectedIndexChanging="GrdVwRecords_SelectedIndexChanging" SkinID="GrdVwMaster">
                                      <Columns>
                                          ...
                                          <asp:TemplateField HeaderText="Code">
                                              <ItemTemplate>
                                                  <asp:Label ID="LblgrpName" runat="server" SkinID="LblGrdMaster" Text='<%# Eval("Code") %>' Width="150px"></asp:Label>
                                              </ItemTemplate>
                                          </asp:TemplateField>
