...
using System.Data;
public class ClsAcademicStaffStudent : ClsCommonBaseMaster, IMasterCommands
{
    private int nStaffId = 0, nInstGrpId = 0, nClassId = 0, nDivisionId = 0, nSubjectId = 0, nStudentId=0;
    public ClsAcademicStaffStudent() : base("TblAcademicStaffStudent", "ID", 0, 0, 0, 0)
    {
    }
    public ClsAcademicStaffStudent(ref int PrmCompanyId, ref int PrmBranchId, ref int PrmFaId, ref int PrmAcId)
        : base("TblAcademicStaffStudent", "ID", PrmCompanyId, PrmBranchId, PrmFaId, PrmAcId)
    {
    }
    public int StaffId
    {
    ...
    public override object ManipulateData(string PrmDbFlag)
    {
        ...
        {
            return objDBManager.GetRecord("ProAcademicStaffStudent", objFields) as DataSet;
        }
        else
        {
            ArrayList objRetArrList = new ArrayList(objDBManager.UpdateRecord("ProAcademicStaffStudent", objFields));
