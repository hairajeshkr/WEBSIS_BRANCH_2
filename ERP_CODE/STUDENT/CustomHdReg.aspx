<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CustomHdReg.aspx.cs" Inherits="STUDENT_CustomHdReg" StyleSheetTheme="SkinFile" Theme="SkinFile" %>
          ...
          <ajaxToolkit:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
              ...
              <ContentTemplate>
                   <table class="auto-style1">
                      <tr><td class="odd" style="width: 128px">
                              <asp:Label ID="Label122" runat="server" Text="Head Name" Width="110px"></asp:Label>
                          </td>
                          <td class="odd">
                              <asp:TextBox ID="TxtName" runat="server" placeholder="Head Name"></asp:TextBox>
                          </td>
                          </tr>
                        <tr>
                     ...
                     <tr>
                        ...
                        <tr>
                          <td class="odd" style="width: 128px"></td>
                          <td class="odd">
