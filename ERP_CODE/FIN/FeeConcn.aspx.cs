...
public partial class FIN_Concession : ClsPageEvents,IPageInterFace
{
    ClsConcessionMaster ObjCls = new ClsConcessionMaster();
    ...
    public override void FnInitializeForm()
    {
        ...
        ObjCls = new ClsConcessionMaster(ref iCmpId, ref iBrId, ref iFaId, ref iAcId);
    ...
    public void FnAssignProperty()
    {
        ...
        ObjCls.Priority = ObjCls.FnIsNumeric(TxtPriority.Text);
        ObjCls.PrintName = TxtPrName.Text.Trim();
    ...
    protected void GrdVwRecords_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        try
        {
            ...
            TxtPrName.Text = ObjCls.PrintName.ToString();
