<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="QuotaReg.aspx.cs" Inherits="STUDENT_QuotaReg" StyleSheetTheme="SkinFile" Theme="SkinFile" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="ajaxToolkit" %>
<%@ Register src="../CtrlCommand.ascx" tagname="CtrlCommand" tagprefix="uc1" %>
<%@ Register src="../CtrlGridList.ascx" tagname="CtrlGridList" tagprefix="uc2" %>
<%@ Register src="../CtrlDate.ascx" tagname="CtrlDate" tagprefix="uc3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script language="javascript" src="Script/Quota.js" type="text/javascript"></script>
    ...
    <div style="height:385px; width:569px">
      <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="385px" Width="560px" BorderColor="White" BorderStyle="Solid"  BorderWidth="0px" style="border:1px solid #fff !important;">
          <ajaxToolkit:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
              <HeaderTemplate> Admission Quota
              </HeaderTemplate>
              
               <ContentTemplate>
                   <table class="auto-style1">
                      <tr><td class="odd" style="width: 186px">
                              <asp:Label ID="Label122" runat="server" Text="Quota Name" Width="100px"></asp:Label>
                          </td>
                          <td class="odd">
                              <asp:TextBox ID="TxtName" runat="server" placeholder="Quota Name"></asp:TextBox>
                          </td>
                          </tr>
                        <tr>
                          <td class="even" style="width: 186px">
                       ...
                       <tr>
                         <td class="odd" style="width: 186px">
                              <asp:Label ID="Label1" runat="server" Text="Maximum No. of Admission" Width="180px"></asp:Label>
                          </td>
                          <td class="odd">
                              <asp:TextBox ID="TxtMaxAddmission" runat="server" placeholder="Enter Numbers"></asp:TextBox>
                          </td>
                      </tr>
                        ...
                        <tr>
                          <td class="odd" style="width: 186px"></td>
                          <td class="odd">
          ...
          <ajaxToolkit:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
              <HeaderTemplate>Admission Quota List
              </HeaderTemplate>
                                  ...
                                  <asp:GridView ID="GrdVwRecords" runat="server"  OnPageIndexChanging="GrdVwRecords_PageIndexChanging" OnSelectedIndexChanging="GrdVwRecords_SelectedIndexChanging" SkinID="GrdVwMaster">
                                      <Columns>
                                          <asp:TemplateField HeaderText="Name">
                                           ...
                                           <asp:TemplateField HeaderText="Max. No. Of Admission">
                                                <ItemTemplate>
                                                  <asp:Label ID="LblMaxAdm" runat="server" SkinID="LblGrdMaster" Text='<%# Eval("MaxAdm") %>' Width="100px"></asp:Label>
                                              </ItemTemplate>
                                           </asp:TemplateField>
