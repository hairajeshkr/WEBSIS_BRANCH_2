<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="HouseReg.aspx.cs" Inherits="STUDENT_HouseReg" StyleSheetTheme="SkinFile" Theme="SkinFile" %>
          ...
          <ajaxToolkit:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
              ...
              <ContentTemplate>
                   <table class="auto-style1">
                      <tr><td class="odd">
                              <asp:Label ID="Label122" runat="server" Text="House Name" Width="100px"></asp:Label>
                          </td>
                          <td class="odd">
                              <asp:TextBox ID="TxtName" runat="server" placeholder="House Name"></asp:TextBox>
                          </td>
                          </tr>
                        <tr>
                          <td class="even">
