<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ClassReg.aspx.cs" Inherits="STUDENT_ClassReg" StyleSheetTheme="SkinFile" Theme="SkinFile" %>
               ...
               <ContentTemplate>
                   <table class="auto-style1">
                      <tr><td class="odd" style="width: 83px">
                              <asp:Label ID="Label122" runat="server" Text="Class Name" Width="100px"></asp:Label>
                          </td>
                          <td class="odd">
                              <asp:TextBox ID="TxtName" runat="server" placeholder="Class Name"></asp:TextBox>
                          </td>
                          <td class="odd"></td>
                          </tr>
                        <tr>
                       ...
                       <tr>
                         <td class="odd" style="width: 83px">
                              <asp:Label ID="Label1" runat="server" Text="Priority" Width="100px"></asp:Label>
                          </td>
                          <td class="odd">
