...
public partial class STUDENT_DivisionReg : ClsPageEvents, IPageInterFace
{
    ClsClassDivision ObjCls = new ClsClassDivision();
    ...
    public void FnAssignProperty()
    {
        ...
        ObjCls.ParentId = ObjCls.FnIsNumeric(CtrlGrdCls.SelectedValue.ToString());
    ...
    protected void GrdVwRecords_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        try
        {
            ...
            CtrlGrdCls.SelectedValue = ObjCls.ParentId.ToString();
            CtrlGrdCls.SelectedText = ObjCls.Parent.ToString();
