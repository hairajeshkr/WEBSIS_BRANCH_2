...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="height: 550px; width: 1180px">
        <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="540px" Width="1175px" BorderColor="White" BorderStyle="Solid" BorderWidth="0px" Style="border: 1px solid #fff !important;">
                        ...
                        <tr>
                            <td class="odd" colspan="7">
                                <table class="upload-field-parent" style="width: 63%">
                                    <tr>
                                        <td>
                                            <div class="result-list" style="overflow: scroll; height: 400px; width: 1100px;">
                                                <asp:GridView ID="GrdVwRecords" runat="server" SkinID="GrdVwMasterNoPageing" OnRowDataBound="GrdVwRecords_RowDataBound">
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Student Id">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="TxtStuId" runat="server" Text='<%# Eval("Code") %>'></asp:TextBox>
                                                        ...
                                                        <asp:TemplateField HeaderText="Student Mob.No.">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="TxtStMobNo" runat="server" Text='<%# Eval("MobNo") %>'></asp:TextBox>
                                                                <%--<asp:TextBox ID="TxtMobile" runat="server" Text='<%# Eval("PhoneNo") %>'  ></asp:TextBox>--%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Father Mob.No.">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="TxtFthrMobNo" runat="server" Text='<%# Eval("FatherMobNo1") %>'></asp:TextBox>
                                                                <%--<asp:TextBox ID="TxtMobile" runat="server" Text='<%# Eval("PhoneNo") %>'  ></asp:TextBox>--%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Mother Mob.No.">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="TxtMthrMobNo" runat="server" Text='<%# Eval("MotherMobNo1") %>'></asp:TextBox>
                                                                <%--<asp:TextBox ID="TxtMobile" runat="server" Text='<%# Eval("PhoneNo") %>'  ></asp:TextBox>--%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Guardian Mob.No.">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="TxtGrdMobNo" runat="server" Text='<%# Eval("GuardianMobNo1") %>'></asp:TextBox>
                                                                <%--<asp:TextBox ID="TxtMobile" runat="server" Text='<%# Eval("PhoneNo") %>'  ></asp:TextBox>--%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
