<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="LanguageReg.aspx.cs" StylesheetTheme="SkinFile" Inherits="STUDENT_LanguageReg" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script language="javascript" src="Script/LanguageReg.js" type="text/javascript"></script>
    <div style="height:367px; width:569px">
        <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="382px" Width="560px" BorderColor="White" BorderStyle="Solid" BorderWidth="0px" Style="border: 1px solid #fff !important;">
            <ajaxToolkit:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
                ...
                <ContentTemplate>
                    ...
                    <table class="auto-style1">
                        ...
                        <tr>
                            <td class="odd" style="width: 90px; height: 30px">
                                <asp:Label ID="Label3" runat="server" Text="Order Index" Width="90px" Height="30px"></asp:Label>
                            </td>
                            <td class="odd" style="width: 319px; height: 40px">
