                      ...
                      <asp:GridView ID="GrdVwRecords" runat="server" OnPageIndexChanging="GrdVwRecords_PageIndexChanging" OnSelectedIndexChanging="GrdVwRecords_SelectedIndexChanging" SkinID="GrdVwMaster">
                          <Columns>
                              ...
                              <asp:TemplateField HeaderText="Admission Class">
                                  <ItemTemplate>
                                      <asp:LinkButton ID="LblInstitution" runat="server" CommandName="SELECT" SkinID="LnkBtnGrdMain" Text='<%# Eval("Class") %>' Width="100px"></asp:LinkButton>
                                  </ItemTemplate>
                              </asp:TemplateField>
                              <asp:TemplateField HeaderText="Quota">
                                  <ItemTemplate>
                                      <asp:LinkButton ID="LblBoard" runat="server" CommandName="SELECT" SkinID="LnkBtnGrdMain" Text='<%# Eval("Quota") %>' Width="200px"></asp:LinkButton>
                                  </ItemTemplate>
                              </asp:TemplateField>
                              <asp:TemplateField HeaderText="Category">
                                  <ItemTemplate>
                                      <asp:LinkButton ID="LblBoard" runat="server" CommandName="SELECT" SkinID="LnkBtnGrdMain" Text='<%# Eval("Category") %>' Width="200px"></asp:LinkButton>
                                  </ItemTemplate>
                              </asp:TemplateField>
                     ...
                     <table class="auto-style1">
                        ...
                        <tr>
                         ...
                         <td class="odd" height="30px" style="width: 180px; height: 30px;">
                             ...
                             <uc1:CtrlGridList ID="CtrlGrdQuota" runat="server" PlaceHoldr="Quota"/>
                               
                          </td>
                       </tr>
                         <tr>
                             <td class="odd" height="30px" style="width: 90px; height: 30px">
                              <asp:Label ID="Label24" runat="server" Text="Category" Width="90px"></asp:Label>
                          </td>
                           <td class="odd" height="30px" width="180px">
                               <uc2:CtrlGridList ID="CtrlGrdCategory" runat="server" PlaceHoldr="Category"/>
                           </td>
