...
public partial class FaYear : ClsPageEvents, IPageInterFace
{
    ...
    protected void GrdVwRecords_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        try
        {
            ...
            CtrlFrmDate.DateText = ObjCls.FnDateTime(ObjCls.FromDate, "dd/MMM/yyyy");
            CtrlToDate.DateText = ObjCls.FnDateTime(ObjCls.ToDate, "dd/MMM/yyyy");
