...
function ValidateGenerateData() {
    ...
    if (!isEmpty(TxtTrDate, 'Please enter Bill Date.', TxtTrDate) && FnCheckFaYearTrDate(TxtTrDate) &&
         isListSelected(DdlSalesAccount, 'Please select valid Purchase type.', DdlSalesAccount, 0)) {
        return true;
    }
    else {
        return false;
