<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FineMasterReg.aspx.cs" StyleSheetTheme="SkinFile" Inherits="STUDENT_FineMasterReg" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="ajaxToolkit" %>
<%@ Register src="../CtrlCommand.ascx" tagname="CtrlCommand" tagprefix="uc1" %>
<%@ Register src="../CtrlGridList.ascx" tagname="CtrlGridList" tagprefix="uc2" %>
<%@ Register src="../CtrlDate.ascx" tagname="CtrlDate" tagprefix="uc3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        <script language="javascript" src="Script/FineMaster.js" type="text/javascript"></script>
    <div style="height:367px; width:569px">
      <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="380px" Width="560px" BorderColor="White" BorderStyle="Solid" BorderWidth="0px" style="border:1px solid #fff !important;">
          <ajaxToolkit:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
              <HeaderTemplate> Fine Registration
              </HeaderTemplate>
              
              <ContentTemplate>
                  <table class="auto-style1">
                      <tr><td class="odd" style="width: 49px">
                              <asp:Label ID="Label1" runat="server" Text="Fine Name" Width="80px"></asp:Label>
                          </td>
                          <td class="odd">
                              <asp:TextBox ID="TxtName" runat="server" placeholder="Fine Name"></asp:TextBox>
                          </td>
                          </tr>
                      <tr><td class="odd" style="width: 49px">
                              <asp:Label ID="Label5" runat="server" Text="Code" Width="80px" ></asp:Label>
                          </td>
                          <td class="odd">
                       ...
                       <tr>
                          <td class="even" style="width: 49px">
                              <asp:Label ID="Label6" runat="server" Text="Priority" Width="80px"></asp:Label>
                          </td>
                          <td class="even" style="height: 35px"> 
                      ...
                      <tr>
                          <td class="even" style="width: 49px">
                              <asp:Label ID="Label12" runat="server" Text="Remarks" Width="80px"></asp:Label>
                          </td>
                          <td class="even">
                       ...
                       <tr>
                          <td class="odd" style="width: 49px"></td>
                          <td class="odd">
              ...
              <ContentTemplate>
                  <table style="width: 100%; height: 0px;">
                      <tr class="result-head">                         
                          ...
                          <td style="height: 39px">
                              <asp:Button ID="BtnFind" runat="server" Text="Find" OnClick="ManiPulateDataEvent_Clicked" Width="69px" CommandName="FIND" SkinID="BtnCommandFindNew" />
                          </td>
                      </tr>
                      <tr>
                          <td colspan="5">
                                  ...
                                  <asp:GridView ID="GrdVwRecords" runat="server" OnPageIndexChanging="GrdVwRecords_PageIndexChanging" OnSelectedIndexChanging="GrdVwRecords_SelectedIndexChanging" SkinID="GrdVwMaster">
                                      <Columns>
                                         ...
                                         <asp:TemplateField HeaderText="Code">
                                              ...
                                              <ItemTemplate>
                                                  <asp:Label ID="LblPriority" runat="server" SkinID="LblGrdMaster" Text='<%# Eval("Priority") %>' Width="150px"></asp:Label>
                                              </ItemTemplate>
                                          </asp:TemplateField>--%>
