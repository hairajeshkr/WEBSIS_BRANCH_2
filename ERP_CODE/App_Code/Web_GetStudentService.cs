...
public class Web_GetStudentService : System.Web.Services.WebService
{
    ...
    [WebMethod()]
    //public string[] FnUpdateStudentMarkEntry(string StaffId, string StudGrpId, string PaperId, string ExamId, string ExamSubId, string ClassId, string DivId, string StudentId, string nMark, string MaxMark, DateTime examdate,String StuDStatus)
     public string[] FnUpdateStudentMarkEntry(string PrmCmpId, string PrmBrId, string PrmAcId, string PrmFaId, string PrmTType, string PrmUserId, string PrmTokenNo, string PrmId, string StaffId, string StudGrpId, string PaperId, string ExamId, string ExamSubId, string ClassId, string DivId, string StudentId, string nMark, string MaxMark, string StuDStatus)
     {
        ...
        ObjCls.Mark= ObjCls.FnIsNumeric(nMark);
