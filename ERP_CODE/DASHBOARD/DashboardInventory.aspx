<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DashboardInventory.aspx.cs" Inherits="DashboardInventory" %>
...
<div class="">
        ...
        <div class="top_tiles">
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                <div class="tile-stats tile-bck-orange ">
                    <div class="icon tile-font-white"><i class="fa fa-cube"></i></div>
                    <div class="count tile-font-white"><span runat="server" id="SpnCnt1">179</span></div>
                    <h3 class="tile-font-white">Total products</h3>
                    <p></p>
                </div>
            </div>
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                <div class="tile-stats tile-bck-red">
                    <div class="icon tile-font-white"><i class="fa fa-cube" style="text-align:right;"></i></div>
                    <div class="count tile-font-white"><span runat="server" id="SpnCnt2">179</span></div>
                    <h3 class="tile-font-white">Low stock products</h3>
                    <p></p>
                </div>
            </div>
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                <div class="tile-stats tile-bck-vilote">
                    ...
                    <h3 class="tile-font-white">Out of stock products</h3>
                    <p></p>
                </div>
            </div>
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                <div class="tile-stats tile-bck-blue">
                    ...
                    <h3 class="tile-font-white">Zero stock products</h3>
                    <p></p>
                </div>
            </div>
              <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                <div class="tile-stats tile-bck-green">
                    ...
                    <h3 class="tile-font-white">Most stock products</h3>
                    <p></p>
                </div>
            </div>
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                <div class="tile-stats tile-bck-Lblue">
                    ...
                    <h3 class="tile-font-white">Upcoming expire </h3>
                    <p></p>
                </div>
            </div>
            <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                <div class="tile-stats tile-bck-dark">
                    ...
                    <h3 class="tile-font-white">Total receipt's</h3>
                    <p></p>
                </div>
            </div>
             <div class="animated flipInY col-lg-3 col-md-3 col-sm-6 ">
                <div class="tile-stats tile-bck-Dvilote">
                    ...
                    <h3 class="tile-font-white">Total issue's</h3>
                    <p></p>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Recent Receipt List <small>Sessions</small></h2>
                ...
                <div class="x_content">
                     <asp:Repeater runat="server" ID="RptrReceiptLst">
                        <ItemTemplate>
        ...
        <div class="col-md-4">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Recent Issue List <small>Sessions</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                        </li>
                        <li class="dropdown">
                ...
                <div class="x_content">
                  <asp:Repeater runat="server" ID="RptrIssueLst">
                        <ItemTemplate>
                            <article class="media event" style="padding-bottom: 2px;">
                                <a class="pull-left date">
                                    <p class="month"><%#Eval("MonthVal")%></p>
        ...
        <div class="col-md-4">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Upcoming Exipre Item List <small>Sessions</small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                        <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                        </li>
                        <li class="dropdown">
                ...
                <div class="x_content">
                    <asp:Repeater runat="server" ID="RptrExpireLst">
                        <ItemTemplate>
                            <article class="media event" style="padding-bottom: 2px;">
                                <a class="pull-left date">
                                    <p class="month"><%#Eval("MonthVal")%></p>
