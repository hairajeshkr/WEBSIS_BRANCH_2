...
public partial class CtrlAddCommand : System.Web.UI.UserControl
{
    ...
    {
        TblCmd.Visible = true;
        BtnAdd.Attributes.Add("onclick", "javascript:return ValidateChildData();");// ctl00_ContentPlaceHolder1_ctl00_BtnSave.disabled=true;__doPostBack('ctl00$ContentPlaceHolder1$ctl00$BtnSave','');");
