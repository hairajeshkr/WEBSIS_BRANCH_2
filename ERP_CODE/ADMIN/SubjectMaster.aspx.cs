...
public partial class ADMIN_SubjectMaster : ClsPageEvents, IPageInterFace
{
    ...
    public void FnAssignProperty()
    {
        ...
        ObjCls.IsElective =ObjCls.FnIsNumeric( (ChkIsElective.Checked == true ? true : false));
        ObjCls.IsOptional = ObjCls.FnIsNumeric((ChkIsElective.Checked == true ? true : false));
    ...
    protected void GrdVwRecords_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        try
        {
            ...
            ChkIsElective.Checked = ObjCls.FnIsBoolean(ObjCls.IsElective);
            ChkIsOptional.Checked = ObjCls.FnIsBoolean(ObjCls.IsOptional);
