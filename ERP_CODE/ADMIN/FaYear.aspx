<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FaYear.aspx.cs" Inherits="FaYear" StyleSheetTheme="SkinFile" Theme="SkinFile" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="ajaxToolkit" %>
<%@ Register src="../CtrlCommand.ascx" tagname="CtrlCommand" tagprefix="uc1" %>
<%@ Register src="../CtrlGridList.ascx" tagname="CtrlGridList" tagprefix="uc2" %>
<%@ Register src="../CtrlDate.ascx" tagname="CtrlDate" tagprefix="uc3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script language="javascript" src="Script/FaYear.js" type="text/javascript"></script>
    <div style="height:367px; width:569px">
      <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="365px" Width="560px" BorderColor="White" BorderStyle="Solid" BorderWidth="0px" style="border:1px solid #fff !important;">
          <ajaxToolkit:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
              <HeaderTemplate> Financial Year Registration
              </HeaderTemplate>
              ...
              <ContentTemplate>
                  <table class="auto-style2">
                      ...
                      <tr>
                          <td class="odd">
                              <asp:Label ID="Label8" runat="server" Text="From Date" Width="125px"></asp:Label>
                          </td>
                      ...
                      <tr>
                          <td class="odd">
                              <asp:Label ID="Label16" runat="server" Text="To Date" Width="125px"></asp:Label>
                          </td>
          ...
          <ajaxToolkit:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
              <HeaderTemplate>Financial Year List
              </HeaderTemplate>
                                      ...
                                      <Columns>
                                         ...
                                         <asp:TemplateField HeaderText="Code">
                                          ...
                                          <asp:TemplateField HeaderText="From Date">
                                              <ItemTemplate>
                                                  <asp:Label ID="LblFrmDate" runat="server" SkinID="LblGrdMaster" Text='<%# Bind("FromDate", "{0:dd-MMM-yyy}") %>' Width="150px"></asp:Label>
                                              </ItemTemplate>
                                          </asp:TemplateField>
                                          <asp:TemplateField HeaderText="To Date">
                                              <ItemTemplate>
                                                  <asp:Label ID="LblUomName" runat="server" SkinID="LblGrdMaster" Text='<%# Bind("ToDate", "{0:dd-MMM-yyy}") %>' Width="150px"></asp:Label>
                                              </ItemTemplate>
                                          </asp:TemplateField>
