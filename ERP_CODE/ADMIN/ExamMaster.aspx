<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ExamMaster.aspx.cs" Inherits="ADMIN_ExamMaster" StyleSheetTheme="SkinFile" Theme="SkinFile" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="ajaxToolkit" %>
<%@ Register src="../CtrlCommand.ascx" tagname="CtrlCommand" tagprefix="uc1" %>
<%@ Register src="../CtrlGridList.ascx" tagname="CtrlGridList" tagprefix="uc2" %>
<%@ Register src="../CtrlDate.ascx" tagname="CtrlDate" tagprefix="uc3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <script language="javascript" src="Script/ExamMaster.js" type="text/javascript"></script>
    <div style="height:460px; width:700px">
      <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="460px" Width="700px" BorderColor="White" BorderStyle="Solid"  BorderWidth="0px" style="border:1px solid #fff !important;">
          <ajaxToolkit:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
              <HeaderTemplate> Academic Exam
              </HeaderTemplate>
               <ContentTemplate>
                   <table class="auto-style1">
                      <tr><td class="odd" style="width: 83px">
                              <asp:Label ID="Label122" runat="server" Text="Exam Name" Width="100px"></asp:Label>
                          </td>
                          <td class="odd" colspan="2">
                              <asp:TextBox ID="TxtName" runat="server" placeholder="Exam Name"></asp:TextBox>
                          </td>
                          </tr>
                        <tr><td class="odd" style="width: 83px">
                        ...
                        <tr>
                         <td class="odd" style="width: 40px">
                              <asp:Label ID="Label5" runat="server" Text="Minimum Marks" Width="102px"></asp:Label>
                          </td>
                          <td class="odd">
                              <asp:TextBox ID="TxtMinMark" runat="server" placeholder="Minimum Marks" SkinID="TxtCode" ></asp:TextBox>
                          </td>
                             <td class="odd">
                                 <asp:Label ID="Label6" runat="server" Text="Maximum Marks" Width="109px" Height="32px"></asp:Label>
                                 <asp:TextBox ID="TxtMaxMark" runat="server" placeholder="Maximum Marks" SkinID="TxtCode"></asp:TextBox>
                            </td>
                      </tr>
                        <tr>
          ...
          <ajaxToolkit:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
              <HeaderTemplate>Academic Exam List
              </HeaderTemplate>
                              ...
                              <div class="result-list" style="overflow: scroll; height: 390px; width: 680px;">
                                  <asp:GridView ID="GrdVwRecords" runat="server"   SkinID="GrdVwMaster" OnSelectedIndexChanging="GrdVwRecords_SelectedIndexChanging">
                                      <Columns>
                                          ...
                                          <asp:TemplateField HeaderText="Minimum Mark">
                                              <ItemTemplate>
                                                  <asp:Label ID="LblMinimumMark" runat="server" SkinID="LblGrdMaster" Text='<%# Eval("MinMark") %>' Width="100px"></asp:Label>
                                              </ItemTemplate>
                                          </asp:TemplateField>
                                          <asp:TemplateField HeaderText="Maximum Mark">
                                              <ItemTemplate>
                                                  <asp:Label ID="LblMaximumMark" runat="server" SkinID="LblGrdMaster" Text='<%# Eval("MaxMark") %>' Width="100px"></asp:Label>
                                              </ItemTemplate>
                                          </asp:TemplateField>
