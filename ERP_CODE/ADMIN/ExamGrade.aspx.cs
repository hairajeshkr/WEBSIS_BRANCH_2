...
using System.Data;
public partial class ADMIN_ExamGrade : ClsPageEvents, IPageInterFace
{
    ClsAcademicGradeMaster ObjCls = new ClsAcademicGradeMaster();
    ...
    public override void FnInitializeForm()
    {
        ...
        ObjCls = new ClsAcademicGradeMaster(ref iCmpId, ref iBrId, ref iFaId, ref iAcId);
    ...
    public void FnAssignProperty()
    {
        ...
        ObjCls.GradePoint = ObjCls.FnIsNumeric( TxtGradePoint.Text.Trim());
    ...
    protected void GrdVwRecords_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        try
        {
            ...
            TxtRangeTo.Text = ObjCls.RangeTo.ToString();
            TxtGradePoint.Text = ObjCls.GradePoint.ToString();
