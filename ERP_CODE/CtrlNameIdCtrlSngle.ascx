<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CtrlNameIdCtrlSngle.ascx.cs" Inherits="CtrlNameIdCtrlSngle" %>
<style type="text/css">
    .auto-style1 {
        width: 12%;
    }
...
<table border="0" cellpadding="0" cellspacing="0" style="width: 1px; position: static; height: 3px;">
    <tr>
        <td align="center" style="padding-right: 2px; padding-left: 2px; margin-left: 2px;
            ...
            <asp:TextBox ID="TxtName" runat="server" SkinID="TxtSngDisable" Style="position: static;" AutoPostBack="false"></asp:TextBox></td>
    </tr>
</table>
