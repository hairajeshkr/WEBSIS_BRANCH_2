<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="FeeConcn.aspx.cs" Inherits="FIN_Concession" StyleSheetTheme="SkinFile" Theme="SkinFile" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="ajaxToolkit" %>
<%@ Register src="../CtrlCommand.ascx" tagname="CtrlCommand" tagprefix="uc1" %>
<%@ Register src="../CtrlGridList.ascx" tagname="CtrlGridList" tagprefix="uc2" %>
<%@ Register src="../CtrlDate.ascx" tagname="CtrlDate" tagprefix="uc3" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script language="javascript" src="Script/Concession.js" type="text/javascript"></script>
    ...
    <div style="height:367px; width:569px">
      <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="1" Height="380px" Width="560px" BorderColor="White" BorderStyle="Solid"  BorderWidth="0px" style="border:1px solid #fff !important;">
          <ajaxToolkit:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
              ...
              <ContentTemplate>
                   ...
                   <table class="auto-style1">
                      <tr><td class="odd">
                              <asp:Label ID="Label122" runat="server" Text="Concession Name" Width="125px"></asp:Label>
                          </td>
                          <td class="odd">
                              <asp:TextBox ID="TxtName" runat="server" placeholder="Concession Name"></asp:TextBox>
                          </td>
                          </tr>
                       <tr>
                          <td class="even">
                       ...
                       <tr>
                          <td class="even">
                              <asp:Label ID="Label4" runat="server" Text="Print Name" Width="125px"></asp:Label>
                          </td>
                          <td class="even">
                              <asp:TextBox ID="TxtPrName" runat="server" placeholder="Print Name" ></asp:TextBox>
                          </td>
                          </tr>
          ...
          <ajaxToolkit:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
              <HeaderTemplate>Concession List
              </HeaderTemplate>
                                  ...
                                  <asp:GridView ID="GrdVwRecords" runat="server" OnPageIndexChanging="GrdVwRecords_PageIndexChanging" OnSelectedIndexChanging="GrdVwRecords_SelectedIndexChanging" SkinID="GrdVwMaster">
                                      <Columns>
                                          ...
                                          <asp:TemplateField HeaderText="Print Name">
                                              <ItemTemplate>
                                                  <asp:Label ID="LblPrintName" runat="server" SkinID="LblGrdMaster" Text='<%# Eval("PrintName") %>' Width="100px"></asp:Label>
                                              </ItemTemplate>
                                          </asp:TemplateField>
