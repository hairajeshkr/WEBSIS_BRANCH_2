...
public partial class STUDENT_StudentCommReg : ClsPageEvents,IPageInterFace
{
    ...
    public void FnAssignProperty()
    {
        ...
        ObjCls.ParentId = ObjCls.FnIsNumeric(CtrlGrdReligion.SelectedValue.ToString());
    ...
    protected void GrdVwRecords_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        try
        {
            ...
            CtrlGrdReligion.SelectedText = ObjCls.Parent.ToString();
            CtrlGrdReligion.SelectedValue = ObjCls.ParentId.ToString();
