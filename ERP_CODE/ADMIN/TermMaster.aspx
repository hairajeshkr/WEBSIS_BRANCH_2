<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TermMaster.aspx.cs" Inherits="ADMIN_TermMaster" StyleSheetTheme="SkinFile" Theme="SkinFile" %>
    ...
    <div style="height:365px; width:569px">
      <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="1" Height="365px" Width="560px" BorderColor="White" BorderStyle="Solid"  BorderWidth="0px" style="border:1px solid #fff !important;">
               ...
               <ContentTemplate>
                   <table class="auto-style1">
                      <tr><td class="odd" style="width: 83px">
                              <asp:Label ID="Label122" runat="server" Text="Term Name" Width="100px"></asp:Label>
                          </td>
                          <td class="odd">
          ...
          <ajaxToolkit:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
              <HeaderTemplate>Academic Term List
              </HeaderTemplate>
