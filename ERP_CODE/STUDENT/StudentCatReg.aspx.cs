...
public partial class STUDENT_StudentCatReg : ClsPageEvents,IPageInterFace
{
    ...
    public void FnAssignProperty()
    {
        ...
        ObjCls.IsReservation = (ChkReservation.Checked == true ? true : false);
    ...
    protected void GrdVwRecords_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        try
        {
            ...
            ChkReservation.Checked = ObjCls.IsReservation;
