...
using System.Data;
public partial class STUDENT_ClubReg : ClsPageEvents,IPageInterFace
{
    ClsStudentClub ObjCls = new ClsStudentClub();
    ...
    public override void FnInitializeForm()
    {
       ...
       int iCmpId = FnGetRights().COMPANYID, iBrId = FnGetRights().BRANCHID, iFaId = FnGetRights().FAYEARID, iAcId = FnGetRights().ACYEARID;
        ObjCls = new ClsStudentClub(ref iCmpId, ref iBrId, ref iFaId,ref iAcId);
    ...
    public void FnAssignProperty()
    {
        ...
        ObjCls.ColorCode = TxtColor.Text.Trim();
    ...
    public void FnFindRecord()
    {
        ...
        ObjCls.ColorCode= TxtColor.Text.Trim();  /// maximum no of admission
        FnFindRecord(ObjCls);
        FnGridViewBinding("");
    ...
    protected void GrdVwRecords_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        try
        {
            ...
            TxtColor.Text = ObjCls.ColorCode.ToString();
