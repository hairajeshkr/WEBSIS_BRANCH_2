<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SubExamMaster.aspx.cs" Inherits="ADMIN_SubExamMaster" StyleSheetTheme="SkinFile" Theme="SkinFile" %>
    ...
    <div style="height:460px; width:700px">
      <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="460px" Width="700px" BorderColor="White" BorderStyle="Solid"  BorderWidth="0px" style="border:1px solid #fff !important;">
          <ajaxToolkit:TabPanel runat="server" HeaderText="TabPanel1" ID="TabPanel1">
              <HeaderTemplate> Academic Sub Exam
              </HeaderTemplate>
              
               <ContentTemplate>
                   <table class="auto-style1">
                      <tr><td class="odd" style="width: 83px">
                              <asp:Label ID="Label122" runat="server" Text="Subexam Name" Width="120px"></asp:Label>
                          </td>
                          <td class="odd">
                              <asp:TextBox ID="TxtName" runat="server" placeholder="Subexam Name"></asp:TextBox>
                          </td>
                          </tr>
                      ...
                      <tr>
                        ...
                        <tr>
                         <td class="odd" style="width: 40px">
                              <asp:Label ID="Label5" runat="server" Text="Marks" Width="50px"></asp:Label>
                          </td>
                          <td class="odd">
                              <asp:TextBox ID="TxtMark" runat="server" placeholder="Marks" SkinID="TxtCode" ></asp:TextBox>
                          </td>
                      </tr>
                        <tr>
          ...
          <ajaxToolkit:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
              <HeaderTemplate>Academic Sub Exam List
              </HeaderTemplate>
