...
using System.Data;
public partial class ADMIN_SubExamMaster : ClsPageEvents, IPageInterFace
{
    ...
    public void FnAssignProperty()
    {
        ...
        ObjCls.ParentId = ObjCls.FnIsNumeric(CtrlGrdExam.SelectedValue);
        ObjCls.MaxMark = ObjCls.FnIsNumeric(TxtMark.Text.Trim());
    ...
    protected void GrdVwRecords_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        try
        {
            ...
            CtrlGrdExam.SelectedValue = ObjCls.ParentId.ToString();
            TxtMark.Text = ObjCls.MaxMark.ToString();
