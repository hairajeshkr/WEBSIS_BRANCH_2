                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Student Name">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:HiddenField ID="HdnWeightage" runat="server" Value='<%# Eval("Weightage") %>' />
                                                    <asp:HiddenField ID="HdnFinalMaxMark" runat="server" Value='<%# Eval("FinalMaxMark") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Status">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="DdlStatus" runat="server" Width="83px" AutoPostBack="true" >
