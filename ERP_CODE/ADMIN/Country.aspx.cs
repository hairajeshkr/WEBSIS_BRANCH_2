...
public partial class Country : ClsPageEvents, IPageInterFace
{
    ...
    public override void FnInitializeForm()
    {
        ...
        ObjCls = new ClsCountry(ref iCmpId, ref iBrId, ref iFaId, ref iAcId);
    ...
    protected void GrdVwRecords_SelectedIndexChanging(object sender, GridViewSelectEventArgs e)
    {
        try
        {
            ...
            CtrlGrdGroup.SelectedText = ObjCls.Parent;
            CtrlGrdGroup.SelectedValue = ObjCls.ParentId.ToString();
